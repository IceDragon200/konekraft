#
# konekraft/sasm0/instruction_spec.rb
#
  ...
  module SlateAssembly0
    class InstructionSpec
      ...
      def initialize(opcode, inst_sym, param_types, embed_params)
        ...
        @bytesize     = 1 + @param_types.inject(0) { |r, t| Konekraft::BitTool.type_bytesize(t) }
      ...
      def bytecode_params_fix(params)
        ...
        @param_types.each do |type|
          ...
          when :int16, :integer16, :adr16, :address16
            a = nparams.shift
            b = nparams.shift
            result << Konekraft::BitTool.ary2_to_int16([a, b])
      ...
      def fix_params(params)
        ...
        for (param, type) in zip_params
          ...
          when :int, :int8, :integer, :integer8, :adr, :adr8, :address8
            result << param
          when :int16, :integer16, :adr16, :address16
            result.concat(Konekraft::BitTool.int16_to_be_ary(param))
          when :register, :reg, :reg_pair, :register_pair
            # don't push it
          end
        end
      ...
      def cast_params(params)
        ...
        zip_params.map do |o, t|
          Konekraft::BitTool.data_cast_as(o, t)
        end
      end
