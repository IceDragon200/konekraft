#
# konekraft/sasm0/rasm.rb
#
#
# RASM - Ruby Konekraft Assembly
require 'konekraft/sasm0/assembler'
  ...
  module SlateAssembly0
    module RASM
      class Builder
        ...
        def to_instructions
          Konekraft::SlateAssembly::Assembler.make_instructions(@_list)
        end

        def to_program
          Konekraft::SlateAssembly::Assembler.make_program(to_instructions)
        end
