...
# Sadie's CPU is a 16 bit CPU based on the Intel
...
module Sadie
  module Slate
    class CPU
      ...
      # init_clock
      def init_clock
        @clock = Sadie::Slate::CPU::Clock.new(self)
      end
      ...
      def init_register
        ...
        REGISTERS.each do |code|
          ...
          @register[code] = Sadie::Slate::CPU::Register.new(self, size)
        end.freeze
        REGISTER_PAIR.each_pair do |code, (h_id, l_id)|
          h, l = @register[h_id], @register[l_id]
          @register[code] = Sadie::Slate::CPU::RegisterPair.new(self, h, l)
        end
      ...
      # init_ports
      def init_ports
        @ports = Sadie::Slate::CPU::Ports.new(self, 256, 256)
      end
