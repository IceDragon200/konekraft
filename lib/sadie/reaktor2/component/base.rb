#
# Sadie/lib/sadie/reaktor2/component/base.rb
#   by IceDragon
#   dc 11/03/2013
#   dm 15/08/2013
require 'sadie/internal/callbacks'
require 'sadie/reaktor2/mixin/reaktorable'
...
module Sadie
  module Reaktor2
    class Base
      ...
      include Sadie::Reaktor2::Mixin::Reaktorable
      ...
      # init_energy
      def init_energy
        @energy = Sadie::Reaktor2::Energy.new
      end
      ...
      def import_rktm_h(hsh)
        @id         = hsh["id"]
        @name       = hsh["name"]
        @energy     = Sadie::Reaktor2::Energy.load_rktm_h(hsh["energy"])
      ...
      # indent_s
      def indent_s
        " " * Sadie::Reaktor2::Base.indent.to_i * 2
      end
      ...
      # vlog -> IO
      def vlog
        @vlog || self.class.vlog || Sadie::Reaktor2::Base.vlog
      end
      ...
      def self.register(name)
        ...
        Sadie::Reaktor2.register(self, @registered_name)
      end
